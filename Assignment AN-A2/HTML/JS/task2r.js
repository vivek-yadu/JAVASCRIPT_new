...
let productDesrp = productMaster.map((ele) => {
    return { id: ele.id, name: ele.name, category: ele.category, price: ele.price, quantity: ele.quantity, type: "food" }
});
console.log(productDesrp);